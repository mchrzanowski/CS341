...
public class UserRankingSVD extends SVD {
	
	public UserRankingSVD(int concepts, int maxIterations, List<Triplet> inputData,
	...
	public UserRankingSVD(int concepts, int maxIterations, File trainingFile,
	...
	public static void crossValidate(int concepts, int maxIterations, File trainingFile,
		...
		for (int i = 0; i < KFOLD; i++){
			...
			SVD svd = new UserRankingSVD(concepts, maxIterations, trainingData, lambda, verbose,
	...
	public static void main(String[] args) throws ParseException {
		...
		if (crossValidate){
			UserRankingSVD.crossValidate(concepts, iterations,
					new File(commandLine.getOptionValue("tr")), lambda, verbose);
		}
		else {
			UserRankingSVD svd = new UserRankingSVD(concepts, iterations,
					new File(commandLine.getOptionValue("tr")), lambda, verbose);
			svd.train();
