...
public class UserItemSVD extends SVD {
	
	public UserItemSVD(int concepts, int maxIterations, List<Triplet> inputData,
	...
	public UserItemSVD(int concepts, int maxIterations, File trainingFile,
	...
	public static void crossValidate(int concepts, int maxIterations, File trainingFile,
		...
		for (int i = 0; i < KFOLD; i++){
			...
			SVD svd = new UserItemSVD(concepts, maxIterations, trainingData, lambda, verbose,
	...
	public static void main(String[] args) throws ParseException {
		...
		if (crossValidate){
			UserItemSVD.crossValidate(concepts, iterations,
					new File(commandLine.getOptionValue("tr")), lambda, verbose);
		}
		else {
			UserItemSVD svd = new UserItemSVD(concepts, iterations,
					new File(commandLine.getOptionValue("tr")), lambda, verbose);
